...
from app.api.teacher_lesson_reviews import homework_router as teacher_homework_router
from app.api.teacher_lesson_reviews import router as teacher_lesson_reviews_router
...
api_router.include_router(teacher_homework_router)
api_router.include_router(teacher_lesson_reviews_router)
