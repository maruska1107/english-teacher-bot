START_NOTICE_TEXT = (
    "Привет! Я помогу анализировать транскрипты Zoom-уроков английского языка.\n\n"
    "После завершения урока система получает готовый транскрипт Zoom, "
    "анализирует его с использованием LLM и формирует отчёт для преподавателя.\n\n"
